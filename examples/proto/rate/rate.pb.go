...
var file_rate_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x72, 0x61, 0x74, 0x65,
...
func file_rate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rate_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rate_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Result); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rate_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_rate_proto_msgTypes[3].Exporter = func(v any, i int) any {
